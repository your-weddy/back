...
public class JwtServiceImpl implements JwtService {
    ...
    public JwtServiceImpl(@Value("${jwt.secret}") String secretKeyPlain, @Value("${jwt.access-token-duration}") long accessTokenDuration, @Value("${jwt.refresh-token-duration}") long refreshTokenDuration) {
